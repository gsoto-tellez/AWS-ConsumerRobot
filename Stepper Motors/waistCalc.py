...
N1 = 16  # Teeth for sprocket 1
N2 = 25  # Teeth for sprocket 2
p = 3/8  # Pitch for roller chain & sprockets
...
theta_m = 45  # desired movement in degrees
t_m = 15 #total move time in seconds 
